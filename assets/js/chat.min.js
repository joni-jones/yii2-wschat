...
Helper.t=function(a){var b=$.cookie("chatLang")||"en";return"en"===b?a:Helper.dict[b][a]};Helper.Message.info=function(a){new PNotify({text:a,type:"info",history:!1,icon:!1,styling:"bootstrap3"})};Helper.Message.error=function(a){new PNotify({text:a,type:"error",history:!1,icon:!1,styling:"bootstrap3"})};Helper.uid=function(){return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,function(a){var b=16*Math.random()|0;return("x"==a?b:b&3|8).toString(16)})};return Helper})();
...
$(document).ready(function(){$("body").tooltip({selector:'[data-toggle="tooltip"]'});var a=new Chat.Collections.Rooms(chatList);(new Chat.Views.ChatRoomList({collection:a})).render();currentUserId=currentUserId||$.cookie("chatUserId");var b=new Chat.Room({port:port,currentUserId:currentUserId});currentUserId?b.init():((new Chat.Views.AddUserView).show(),Chat.vent.on("user:set_username",function(a){b.options.username=a;b.init()}));new Chat.Views.ChatView;new Chat.Views.UserListView({collection:b.users})});
